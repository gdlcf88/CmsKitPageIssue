...
public class CmsKitPageIssueDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public CmsKitPageIssueDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
